import { AVAX, BNB, DEV, MATIC, ETHER, HECO, JSBI, Percent, Token, WETH } from '@zeroexchange/sdk'
...
export const ZERO = new Token(1, '0xf0939011a9bb95c3b791f0cb546377ed2693a574', 18, 'ZERO', 'Zero Exchange')
export const DAI = new Token(1, '0x6B175474E89094C44Da98b954EedeAC495271d0F', 18, 'DAI', 'Dai Stablecoin')
export const USDC = new Token(1, '0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48', 6, 'USDC', 'USDC')
...
export const SUSHI = new Token(1, '0x6B3595068778DD592e39A122f4f5a5cF09C90fE2', 18, 'SUSHI', 'Wrapped BTC')
export const WAS = new Token(1, '0x0c572544a4Ee47904d54aaA6A970AF96B6f00E1b', 18, 'WAS', 'Wasder Token')
export const BIOS = new Token(1, '0xAACa86B876ca011844b5798ECA7a67591A9743C8', 18, 'BIOS', 'BIOS')
export const XIOT = new Token(1, '0x31024A4C3e9aEeb256B825790F5cb7ac645e7cD5', 3, 'XIOT', 'Xiotri')
...
// export const bscCHART = new Token(
//   ChainId.SMART_CHAIN,
//   '0xc33A42C9D19f944FA12ff46f27B3B85e18a13778',
//   18,
//   'CHART',
//   'ChartEx'
// )
// export const bscWISB = new Token(
//   ChainId.SMART_CHAIN,
...
// export const rinkebyZERO = new Token(4, '0x9EfCe00Be4E0c2D9aEF18aACe4e273D9ebcf574a', 18, 'ZERO', 'Zero Exchange')
// export const rinkebyUSDC = new Token(4, '0xeb8f08a975Ab53E34D8a0330E0D34de942C95926', 6, 'USDC', 'USDC')
...
export const UNI: { [chainId in ChainId]: Token } = {
  [1]: new Token(1, UNI_ADDRESS, 18, 'UNI', 'Uniswap'),
  // [4]: new Token(4, UNI_ADDRESS, 18, 'UNI', 'Uniswap'),
  [3]: new Token(3, UNI_ADDRESS, 18, 'UNI', 'Uniswap'),
  [77]: new Token(77, UNI_ADDRESS, 18, 'UNI', 'Uniswap'),
  // [5]: new Token(5, UNI_ADDRESS, 18, 'UNI', 'Uniswap'),
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...WETH_ONLY,
  [1]: [...WETH_ONLY[1], DAI, USDC, USDT, ZERO, COMP, MKR],
  [3]: [...WETH_ONLY[1], DAI, USDC, USDT, ZERO, COMP, MKR],
  // [4]: [...WETH_ONLY[4], rinkebyZERO, rinkebyUSDC],
...
export const BASES_TO_TRACK_LIQUIDITY_FOR: ChainTokenList = {
  ...WETH_ONLY,
  [1]: [...WETH_ONLY[1], ZERO, DAI, USDC, USDT],
  // [ChainId.FUJI]: [...WETH_ONLY[ChainId.FUJI], MOCK1, MOCK2]
}
...
export const SUPPORTED_CHAINS = ['Ethereum', 'Sokol', 'Ropsten']
